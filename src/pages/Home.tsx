...
const Home = () => {
  ...
  const projectImages: ProjectImages = {
    projectLaserderm: {
      ...
      description: {
        el: 'Ανακαίνιση και διακόσμηση στούντιο αισθητικής LaserDerm. Αρχιτεκτονικός σχεδιασμός, πλήρης δομική ανανέωση, και λειτουργική υλοποίηση.',
        en: 'Renovation and decoration of LaserDerm aesthetic studio. Architectural design, complete structural renewal, and functional implementation.'
      }
    },
    projectOldHouse: {
      ...
      description: {
        el: 'Ανακατασκευή παλαιάς μονοκατοικίας, μετατροπή σε τρία διαμερίσματα-στούντιο με σύγχρονο αρχιτεκτονικό σχεδιασμό και ενεργειακή αναβάθμιση.',
        en: 'Reconstruction of old house, conversion into three apartments-studio with modern architectural design and energy upgrade.'
      }
    },
    projectArogiArch: {
      ...
      description: {
        el: 'Αρχιτεκτονική μελέτη διώροφης μονοκατοικίας στην παραλία Αρωγής Ροδόπης. Σύγχρονος αρχιτεκτονικός σχεδιασμός με χρήση τοπικών υλικών.',
        en: 'Architectural study of two-story house at Arogi Beach, Rodopi. Modern architectural design using local materials.'
      }
    },
    projectArogiGround: {
      ...
      description: {
        el: 'Ανέγερση ισόγειας παραθεριστικής μονοκατοικίας με σοφίτα στην παραλία Αρωγής. Πλήρης αρχιτεκτονική και στατική μελέτη.',
        en: 'Construction of ground-floor holiday home with attic at Arogi Beach. Complete architectural and structural study.'
      }
    },
    projectEktenepol: {
      ...
      description: {
        el: 'Ανέγερση διώροφης μονοκατοικίας στον Εκτενεπόλ ΖΕΠ Κομοτηνής. Αρχιτεκτονική μελέτη, στατική μελέτη και πλήρης επίβλεψη.',
        en: 'Construction of two-story house in Ektenepol ZEP Komotini. Architectural study, structural study and complete supervision.'
      }
    },
    projectMaroneia: {
      ...
      description: {
        el: 'Ανέγερση πετρόκτιστης κατοικίας στον παραδοσιακό οικισμό Μαρώνειας Ροδόπης. Σεβασμός της παραδοσιακής αρχιτεκτονικής.',
        en: 'Construction of stone house in traditional settlement of Maronia, Rodopi. Respect for traditional architecture.'
      }
    },
    project1: {
    ...
    singleStoryHouse: {
      ...
      description: {
        el: 'Μελέτη ανέγερσης ισόγειας μονοκατοικίας με πρόβλεψη ορόφου. Φωτορεαλιστική απεικόνιση.',
        en: 'Construction study of a single-story house with provision for an additional floor. Photorealistic visualization.'
      },
      images: [as1, ad, af, ag, ah, aj, ak, al]
    },
    prefabHouses: {
      title: {
      ...
      description: {
        el: 'Νέο έργο σε εξέλιξη: Ανέγερση δύο όμοιων προκατασκευασμένων κατοικιών στον παραθεριστικό οικισμό Προφήτη Ηλία.',
        en: 'New project in progress: Construction of two identical prefabricated houses in the holiday settlement of Prophet Elias.'
      },
  ...
  const projectDescriptions = {
    el: [
      ...
      "Νέο έργο υπό κατασκευή. Ανέγερση μονοκατοικίας στις Σάπες Ροδόπης.",
      "Μελέτη ανέγερσης ισόγειας μονοκατοικίας με πρόβλεψη ορόφου. Φωτορεαλιστική απεικόνιση.",
      "Νέο έργο σε εξέλιξη: Ανέγερση δύο όμοιων προκατασκευασμένων κατοικιών στον παραθεριστικό οικισμό Προφήτη Ηλία.",
      "Νέο έργο σε εξέλιξη: Ανέγερση δύο όμοιων προκατασκευασμένων κατοικιών στον παραθεριστικό οικισμό Προφήτη Ηλία."
    ],
    en: [
      ...
      "New project under construction. House construction in Sapes, Rodopi.",
      "Study for the construction of a ground floor house with provision for an additional floor. Photorealistic visualization.",
      "New project in progress: Construction of two identical prefabricated houses in the holiday settlement of Prophet Elias.",
      "New project in progress: Construction of two identical prefabricated houses in the holiday settlement of Prophet Elias."
    ]
  };
      ...
      <div className="relative h-screen">
        ...
        <div className="relative h-full flex items-start pt-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {/* Professional Title */}
              <div className="text-gray-300 text-lg md:text-xl mb-4">
                {language === 'el' 
                  ? (
                    <>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Object.entries(projectImages).map(([key, project]) => (
                <motion.div
                  key={key}
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
