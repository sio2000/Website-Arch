...
const ArchitecturalOffice = () => {
  ...
  const selectedProjects = [
    ...
    },
    {
      ...
      description: {
        el: 'Ανακατασκευή παλαιάς μονοκατοικίας, μετατροπή σε τρία διαμερίσματα-στούντιο με σύγχρονο αρχιτεκτονικό σχεδιασμό και ενεργειακή αναβάθμιση. Πλήρης στατική μελέτη ενίσχυσης φέροντα οργανισμού, αρχιτεκτονικό σχεδιασμό και επίβλεψη κατασκευής.',
        en: 'Reconstruction of old house, conversion into three apartments-studio with modern architectural design and energy upgrade. Complete structural reinforcement study, architectural design and construction supervision.'
      },
    ...
    },
    {
      ...
      description: {
        el: 'Αρχιτεκτονική μελέτη διώροφης μονοκατοικίας στην παραλία Αρωγής Ροδόπης. Σύγχρονος αρχιτεκτονικός σχεδιασμός με χρήση τοπικών υλικών, βάσει των αρχιτεκτονικών προδιαγραφών της περιοχής.',
        en: 'Architectural study of two-story house at Arogi Beach, Rodopi. Modern architectural design using local materials, according to architectural specifications of the area.'
      },
      images: [arogiArch1, arogiArch2, arogiArch3]
    },
    {
      id: 'arogi-ground-floor',
      title: {
      ...
      description: {
        el: 'Ανέγερση ισόγειας παραθεριστικής μονοκατοικίας με σοφίτα στην παραλία Αρωγής. Πλήρης αρχιτεκτονική και στατική μελέτη, επίβλεψη κατασκευής και υλοποίηση.',
        en: 'Construction of ground-floor holiday home with attic at Arogi Beach. Complete architectural and structural study, construction supervision and implementation.'
      },
      images: [arogiGround1, arogiGround2, arogiGround3, arogiGround4]
    },
    {
      id: 'ektenepol-two-story',
      title: {
      ...
      description: {
        el: 'Ανέγερση διώροφης μονοκατοικίας στην περιοχή Εκτενεπόλ ΖΕΠ Κομοτηνής. Αρχιτεκτονική μελέτη, στατική μελέτη, ενεργειακή μελέτη ΚΕΝΑΚ, και πλήρης επίβλεψη εργοταξίου.',
        en: 'Construction of two-story house in Ektenepol ZEP Komotini area. Architectural study, structural study, energy study KENAK, and complete construction supervision.'
      },
      images: [ektenepol1, ektenepol2, ektenepol3]
    },
    {
      id: 'maroneia-stone-house',
      title: {
      ...
      description: {
        el: 'Ανέγερση πετρόκτιστης κατοικίας στον παραδοσιακό οικισμό Μαρώνειας Ροδόπης. Σεβασμός της παραδοσιακής αρχιτεκτονικής, χρήση τοπικών υλικών και διατήρηση του αρχιτεκτονικού χαρακτήρα της περιοχής.',
        en: 'Construction of stone house in traditional settlement of Maronia, Rodopi. Respect for traditional architecture, use of local materials and preservation of architectural character of the area.'
      },
